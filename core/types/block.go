...
// Package types contains data types related to pistchain consensus.
package types
...
// Block represents an entire block in the pistchain blockchain.
type Block struct {
	header       *Header
	...
	// These fields are used by package pist to track
...
// "external" block encoding. used for pist protocol, etc.
...
// DecodeRLP decodes the pistchain
...
// EncodeRLP serializes b into the pistchain RLP block format.
