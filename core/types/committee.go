...
const (
	...
	CommitteeSwitchover
	// CommitteeUpdate update committee members and backpist
	CommitteeUpdate
...
// "external" PbftSign encoding. used for pist protocol, etc.
...
// "external" EncryptNode encoding. used for pist protocol, etc.
