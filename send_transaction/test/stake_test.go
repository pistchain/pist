...
func TestOnlyDeposit(t *testing.T) {
	...
	fmt.Println(" saddr1 ", manager.GetBalance(saddr1), " StakingAddress ", manager.GetBalance(types.StakingAddress), " ", types.ToPist(manager.GetBalance(types.StakingAddress)))
