...
func loop(conn *pistclient.Client, ctx *cli.Context) {
	loopMutex.Lock()
...
func startDelegateTx(conn *pistclient.Client) {
...
func sendTransactions(client *pistclient.Client, value *big.Int) {
...
func initAccount(conn *pistclient.Client) {
...
func sendOtherContractTransaction(client *pistclient.Client, toAddress common.Address, value *big.Int, privateKey *ecdsa.PrivateKey, nonceOther uint64, wait *sync.WaitGroup) (common.Hash, error) {
	defer wait.Done()
...
func sendSonTransaction(client *pistclient.Client, from, toAddress common.Address, value *big.Int, privateKey *ecdsa.PrivateKey, input []byte, method string) (common.Hash, error) {
	blockMutex.Lock()
...
func querySendTx(conn *pistclient.Client) {
