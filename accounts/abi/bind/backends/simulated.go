...
import (
	...
	"git.taiyue.io/pist/go-pist/accounts/abi/bind"
...
type SimulatedBackend struct {
	database   pistdb.Database  // In memory database to store our testing data
...
func NewSimulatedBackendWithDatabase(database pistdb.Database, alloc types.GenesisAlloc, gasLimit uint64) *SimulatedBackend {
...
func NewSimulatedBackend(alloc types.GenesisAlloc, gasLimit uint64) *SimulatedBackend {
	return NewSimulatedBackendWithDatabase(pistdb.NewMemDatabase(), alloc, gasLimit)
}
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call pistchain.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call pistchain.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call pistchain.CallMsg) (uint64, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(ctx context.Context, call pistchain.CallMsg, block *types.Block, statedb *state.StateDB) ([]byte, uint64, bool, error) {
...
func (b *SimulatedBackend) FilterLogs(ctx context.Context, query pistchain.FilterQuery) ([]types.Log, error) {
...
func (b *SimulatedBackend) SubscribeFilterLogs(ctx context.Context, query pistchain.FilterQuery, ch chan<- types.Log) (pistchain.Subscription, error) {
...
func (b *SimulatedBackend) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (pistchain.Subscription, error) {
...
func (fb *filterBackend) ChainDb() pistdb.Database { return fb.db }
