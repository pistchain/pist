...
// level.
//
// Bilinear gropist are the basis of many of the new cryptographic protocols that
// have been proposed over the past decade. They consist of a triplet of gropist
...
// source gropist to F_p^12. Miller(g1, g2).Finalize() is equivalent to Pair(g1,
// g2).
