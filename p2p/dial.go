...
const (
	...
	// Discovery lookpist are throttled and can only run
...
// dialstate schedules dials and discovery lookpist.
...
func (s *dialstate) newTasks(nRunning int, peers map[enode.ID]*Peer, now time.Time) []task {
	...
	log.Trace("New tasks", "maxDynDials", s.maxDynDials, "needDynDials", needDynDials, "static", len(s.static), "task", len(newtasks), "bootnodes", len(s.bootnodes))
...
func (t *discoverTask) Do(srv *Server) {
	...
	// necessary. Lookpist need to take some time, otherwise the
