...
const (
	defaultGasPrice = 10 * params.Shannon
)

var (
	LocalTxMetrics = metrics.NewRegisteredMeter("pist/prop/local_tx/in", nil)
)
...
// Note, this function is compatible with pist__sign and personal_sign. As such it recovers
// the address of:
...
// ExecutionResult gropist all structured logs emitted by the EVM
...
//
// https://github.com/True/wiki/wiki/JSON-RPC#pist_sign
