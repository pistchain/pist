...
// Package pistclient provides a client for the Ethereum RPC API.
package pistclient
...
func (ec *Client) BlockByHash(ctx context.Context, hash common.Hash) (*types.Block, error) {
	return ec.getBlock(ctx, "pist_getBlockByHash", hash, true)
}
...
func (ec *Client) BlockByNumber(ctx context.Context, number *big.Int) (*types.Block, error) {
	return ec.getBlock(ctx, "pist_getBlockByNumber", toBlockNumArg(number), true)
}
...
func (ec *Client) HeaderByHash(ctx context.Context, hash common.Hash) (*types.Header, error) {
	var head *types.Header
	err := ec.c.CallContext(ctx, &head, "pist_getBlockByHash", hash, false)
	if err == nil && head == nil {
		err = pistchain.NotFound
	}
	return head, err
}
...
func (ec *Client) HeaderByNumber(ctx context.Context, number *big.Int) (*types.Header, error) {
	var head *types.Header
	err := ec.c.CallContext(ctx, &head, "pist_getBlockByNumber", toBlockNumArg(number), false)
	if err == nil && head == nil {
		err = pistchain.NotFound
	}
	return head, err
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	err = ec.c.CallContext(ctx, &json, "pist_getTransactionByHash", hash)
	if err != nil {
		return nil, false, err
	} else if json == nil {
		return nil, false, pistchain.NotFound
...
func (ec *Client) TransactionSender(ctx context.Context, tx *types.Transaction, block common.Hash, index uint) (common.Address, error) {
	...
	if err = ec.c.CallContext(ctx, &meta, "pist_getTransactionByBlockHashAndIndex", block, hexutil.Uint64(index)); err != nil {
...
func (ec *Client) TransactionCount(ctx context.Context, blockHash common.Hash) (uint, error) {
	...
	err := ec.c.CallContext(ctx, &num, "pist_getBlockTransactionCountByHash", blockHash)
	return uint(num), err
}
...
func (ec *Client) TransactionInBlock(ctx context.Context, blockHash common.Hash, index uint) (*types.Transaction, error) {
	var json *rpcTransaction
	err := ec.c.CallContext(ctx, &json, "pist_getTransactionByBlockHashAndIndex", blockHash, hexutil.Uint64(index))
	if err == nil {
		if json == nil {
			return nil, pistchain.NotFound
		} else if _, r, _ := json.tx.RawSignatureValues(); r == nil {
...
func (ec *Client) TransactionReceipt(ctx context.Context, txHash common.Hash) (*types.Receipt, error) {
	var r *types.Receipt
	err := ec.c.CallContext(ctx, &r, "pist_getTransactionReceipt", txHash)
	if err == nil {
		if r == nil {
			return nil, pistchain.NotFound
		}
...
func (ec *Client) SyncProgress(ctx context.Context) (*pistchain.SyncProgress, error) {
	var raw json.RawMessage
	if err := ec.c.CallContext(ctx, &raw, "pist_syncing"); err != nil {
		return nil, err
	}
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (pistchain.Subscription, error) {
...
func (ec *Client) BalanceAt(ctx context.Context, account common.Address, blockNumber *big.Int) (*big.Int, error) {
	var result hexutil.Big
	err := ec.c.CallContext(ctx, &result, "pist_getBalance", account, toBlockNumArg(blockNumber))
	return (*big.Int)(&result), err
}
...
func (ec *Client) LockBalanceAt(ctx context.Context, account common.Address, blockNumber *big.Int) (*big.Int, error) {
	var result hexutil.Big
	err := ec.c.CallContext(ctx, &result, "pist_getLockBalance", account, toBlockNumArg(blockNumber))
	return (*big.Int)(&result), err
}
...
func (ec *Client) StorageAt(ctx context.Context, account common.Address, key common.Hash, blockNumber *big.Int) ([]byte, error) {
	...
	err := ec.c.CallContext(ctx, &result, "pist_getStorageAt", account, key, toBlockNumArg(blockNumber))
	return result, err
}
...
func (ec *Client) CodeAt(ctx context.Context, account common.Address, blockNumber *big.Int) ([]byte, error) {
	var result hexutil.Bytes
	err := ec.c.CallContext(ctx, &result, "pist_getCode", account, toBlockNumArg(blockNumber))
	return result, err
}
...
func (ec *Client) NonceAt(ctx context.Context, account common.Address, blockNumber *big.Int) (uint64, error) {
	...
	err := ec.c.CallContext(ctx, &result, "pist_getTransactionCount", account, toBlockNumArg(blockNumber))
...
func (ec *Client) FilterLogs(ctx context.Context, q pistchain.FilterQuery) ([]types.Log, error) {
	var result []types.Log
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
	err = ec.c.CallContext(ctx, &result, "pist_getLogs", arg)
	return result, err
}

// SubscribeFilterLogs subscribes to the results of a streaming filter query.
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q pistchain.FilterQuery, ch chan<- types.Log) (pistchain.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q pistchain.FilterQuery) (interface{}, error) {
...
func (ec *Client) PendingBalanceAt(ctx context.Context, account common.Address) (*big.Int, error) {
	var result hexutil.Big
	err := ec.c.CallContext(ctx, &result, "pist_getBalance", account, "pending")
	return (*big.Int)(&result), err
}
...
func (ec *Client) PendingStorageAt(ctx context.Context, account common.Address, key common.Hash) ([]byte, error) {
	var result hexutil.Bytes
	err := ec.c.CallContext(ctx, &result, "pist_getStorageAt", account, key, "pending")
	return result, err
}
...
func (ec *Client) PendingCodeAt(ctx context.Context, account common.Address) ([]byte, error) {
	var result hexutil.Bytes
	err := ec.c.CallContext(ctx, &result, "pist_getCode", account, "pending")
	return result, err
}
...
func (ec *Client) PendingNonceAt(ctx context.Context, account common.Address) (uint64, error) {
	var result hexutil.Uint64
	err := ec.c.CallContext(ctx, &result, "pist_getTransactionCount", account, "pending")
	return uint64(result), err
}
...
func (ec *Client) PendingTransactionCount(ctx context.Context) (uint, error) {
	var num hexutil.Uint
	err := ec.c.CallContext(ctx, &num, "pist_getBlockTransactionCountByNumber", "pending")
	return uint(num), err
}
...
func (ec *Client) CallContract(ctx context.Context, msg pistchain.CallMsg, blockNumber *big.Int) ([]byte, error) {
	var hex hexutil.Bytes
	err := ec.c.CallContext(ctx, &hex, "pist_call", toCallArg(msg), toBlockNumArg(blockNumber))
	if err != nil {
		return nil, err
	}
	return hex, nil
...
func (ec *Client) PendingCallContract(ctx context.Context, msg pistchain.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
	err := ec.c.CallContext(ctx, &hex, "pist_call", toCallArg(msg), "pending")
	if err != nil {
		return nil, err
	}
	return hex, nil
...
func (ec *Client) SuggestGasPrice(ctx context.Context) (*big.Int, error) {
	var hex hexutil.Big
	if err := ec.c.CallContext(ctx, &hex, "pist_gasPrice"); err != nil {
		return nil, err
	}
...
func (ec *Client) EstimateGas(ctx context.Context, msg pistchain.CallMsg) (uint64, error) {
	var hex hexutil.Uint64
	err := ec.c.CallContext(ctx, &hex, "pist_estimateGas", toCallArg(msg))
	if err != nil {
		return 0, err
	}
...
func (ec *Client) SendTransaction(ctx context.Context, tx *types.Transaction) error {
	...
	return ec.c.CallContext(ctx, nil, "pist_sendTrueRawTransaction", common.ToHex(data))
}
...
func toCallArg(msg pistchain.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
//pist_protocolVersion
func (ec *Client) GetProtocolVersion(ctx context.Context) (string, error) {
	var result string
	err := ec.c.CallContext(ctx, &result, "pist_protocolVersion", nil)
	if err != nil {
		return result, err
	}
	return result, nil
...
func (ec *Client) Coinbase(ctx context.Context) (string, error) {
	var result string
	err := ec.c.CallContext(ctx, &result, "pist_coinbase", nil)
	if err != nil {
		return result, err
	}
	return result, nil
...
func (ec *Client) Pubkey(ctx context.Context) (string, error) {
	var result string
	err := ec.c.CallContext(ctx, &result, "pist_pubkey", nil)
	if err != nil {
		return result, err
	}
	return result, nil
...
func (ec *Client) GetChainRewardContent(ctx context.Context, account common.Address, number *big.Int) (map[string]interface{}, error) {
	var result map[string]interface{}
	err := ec.c.CallContext(ctx, &result, "pist_getChainRewardContent", toBlockNumArg(number), account)
	if err != nil {
		return result, err
	}
	return result, nil
