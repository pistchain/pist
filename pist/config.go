...
// DefaultConfig contains default settings for use on the Pistchain main net.
var DefaultConfig = Config{
	...
	MinervaMode:   0,
	GasPrice:      big.NewInt(10 * params.Shannon),
...
type Config struct {
	...
	// If nil, the Pistchain main net block is used.
