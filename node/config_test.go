...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gpist.ipc", false, filepath.Join(os.TempDir(), "gpist.ipc")},
		{"data", "gpist.ipc", false, "data/gpist.ipc"},
		{"data", "./gpist.ipc", false, "./gpist.ipc"},
		{"data", "/gpist.ipc", false, "/gpist.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gpist.ipc", true, `\\.\pipe\gpist.ipc`},
		{"data", "gpist.ipc", true, `\\.\pipe\gpist.ipc`},
		{"data", `\\.\pipe\gpist.ipc`, true, `\\.\pipe\gpist.ipc`},
	}
