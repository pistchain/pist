...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *pistdb.MemDatabase {
	var provers []func(key []byte) *pistdb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *pistdb.MemDatabase {
		proof := pistdb.NewMemDatabase()
