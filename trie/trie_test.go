...
// Used for testing
func newEmpty() *Trie {
	trie, _ := New(common.Hash{}, NewDatabase(pistdb.NewMemDatabase()))
	return trie
}
...
func TestMissingRoot(t *testing.T) {
	trie, err := New(common.HexToHash("0beec7b5ea3f0fdbc95d0dd47f3c5bc275da8a33"), NewDatabase(pistdb.NewMemDatabase()))
	if trie != nil {
...
func TestReplication(t *testing.T) {
	...
	// create a new trie on top of the database and check that lookpist work.
...
func runRandTest(rt randTest) bool {
	triedb := NewDatabase(pistdb.NewMemDatabase())
...
func benchGet(b *testing.B, commit bool) {
	...
	if commit {
		ldb := trie.db.diskdb.(*pistdb.LDBDatabase)
		ldb.Close()
...
func tempDB() (string, *Database) {
	...
	diskdb, err := pistdb.NewLDBDatabase(dir, 256, 0)
	if err != nil {
