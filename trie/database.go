...
import (
	...
	//"git.taiyue.io/pist/go-pist/ethdb"
...
type Database struct {
	diskdb pistdb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb pistdb.Database) *Database {
...
func NewDatabaseWithCache(diskdb pistdb.Database, cache int) *Database {
...
func (db *Database) Cap(limit common.StorageSize) error {
	...
	if flushPreimages {
		for hash, preimage := range db.preimages {
			...
			if batch.ValueSize() > pistdb.IdealBatchSize {
...
func (db *Database) commit(hash common.Hash, batch pistdb.Batch) error {
